    ...
    <div className="sticky top-0 z-30 border-b border-[var(--rushd-border)] bg-[var(--rushd-header)] px-4 py-2.5 backdrop-blur-2xl md:px-0">
      <div className="container mx-auto flex h-14 items-center justify-between gap-5" dir="rtl">
        <Link to="/dashboard" className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center bg-[var(--rushd-accent)] text-xl font-bold text-[var(--rushd-ink)]">
            ر
          </div>
        ...
        <div className="flex items-center gap-3">
          <button
            type="button"
            onClick={toggleTheme}
            className="flex h-10 w-10 items-center justify-center border border-[var(--rushd-border)] bg-[var(--rushd-card)] text-[var(--rushd-muted)] transition hover:text-[var(--rushd-text)]"
